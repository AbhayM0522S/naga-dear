...
const NavBar: React.FC<NavBarProps> = ({ onSectionChange }) => {
  ...
  const navItems = [
    ...
    { id: 'token', label: 'Token', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', route: '/token' },
    ...
    { id: 'history', label: 'History', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', route: '/history' },
  ];
        ...
        <div className="flex items-center justify-between py-3 gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
            ...
            <div className="flex-shrink-0">
              <img src="/bull-logo.jpg" alt="Nagaland Lottery" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border-2 border-red-700" />
            </div>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2">
                  <div className="px-4 py-3 border-b border-gray-200">
                    <p className="text-sm font-semibold text-gray-800">Subhankar Ghosh</p>
                    <p className="text-xs text-gray-500">subhankar.ghosh@dear.com</p>
